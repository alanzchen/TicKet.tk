...
def hello(request):
	...
	ctt['step1description']='请在下方填写大写的机场三字码，否则无效。'
	ctt['step2description']='请在下方填写大写的机场三字码，否则无效。'
	ctt['step3description']='猛击右边可爱的小红圈圈wwwww'
	ctt['step1input']='比如说：CAN'
	ctt['step2input']='比如说：AEB'
	ctt['step1start']='喵～'
	ctt['step2start']='喵喵～！'
	ctt['step3start']='喵喵喵～～～'
	ctt['ready']='点这里喵～'
